...
function buildSystemPrompt() {
  return [
    ...
    "A. Data status: available period, source_layer_used, freshness, fact_ads_rows/unified_ads_rows, and whether current last-7-days analysis is possible.",
  ...
  return JSON.stringify(
    {
      ...
      response_requirements: {
        ...
        constraints: [
          "mention stale/fallback/imported data when context.data_freshness or source_layer_used indicates it",
