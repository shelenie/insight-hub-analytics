...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "When explicit client communication is requested, wrap only copy-ready client text in [CLIENT_COPY_START] and [CLIENT_COPY_END]. Use those markers only for explicit client communication requests such as сформулюй клієнту, напиши клієнту, що сказати клієнту, для клієнта, client update, client-ready, send to client, message to client.",
    "Inside [CLIENT_COPY_START] / [CLIENT_COPY_END], include only text that can be copied and sent to the client. Do not include Можна сформулювати клієнту так:, Ось так:, markdown separator ---, or internal checklist/notes inside the markers. If useful, put internal notes after [CLIENT_COPY_END] under Внутрішньо: що перевірити. Keep client text practical, transparent, not blamey, and do not overpromise fixes.",
