...
function buildSystemPrompt() {
  return [
    ...
    "For ads_health answers, do not include detailed campaign performance, CPL rankings, weak campaigns, or budget redistribution unless the user explicitly asks for campaign/performance analysis.",
    "For freshness questions like Чому немає свіжих рекламних даних?, answer in 3-4 concise sections: Стан даних, Чому немає свіжих даних, Що перевірити, Що сказати клієнту.",
    "Keep ads_health answers concise: max 8-12 bullets total.",
    "Mention historical campaign data only as a short note when relevant: Історичні дані є за 2026-04-01 — 2026-05-05, але вони не підходять для last-7-days аналізу.",
  ...
  return JSON.stringify(
    {
      ...
      response_requirements: {
        ...
        constraints: [
          ...
          "if request_type is ads_health_summary or context_scope is ads_health, focus on data freshness/readiness/source status/access blockers/binding gaps, not detailed campaign analysis",
          "for ads_health freshness questions use 3-4 concise sections: Стан даних, Чому немає свіжих даних, Що перевірити, Що сказати клієнту",
          "for ads_health answers use max 8-12 bullets total and do not list top campaigns/CPL unless the user explicitly asks",
          "mention historical campaign data only as a short note when relevant: Історичні дані є за 2026-04-01 — 2026-05-05, але вони не підходять для last-7-days аналізу.",
