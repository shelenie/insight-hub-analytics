...
return json({ ok: false, error: "not wired: retry backend function needs confirmation", details: "No confirmed safe backend RPC signature for outbox retry is present in this repository." }, 501);
});
