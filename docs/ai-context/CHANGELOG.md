...
- Moved detailed platform readiness and binding gaps into an expandable details section so the main active bound ad account cards are no longer pushed down by diagnostic tables.
