...
- Tightened `ads_health` prompt behavior around data freshness/readiness/source status/access blockers/Звʼязки даних gaps instead of detailed campaign/CPL analysis unless requested.
