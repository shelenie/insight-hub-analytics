...
2026-07-05 update: Data Bindings manual/admin UX copy has been clarified and routed through existing Ukrainian/English i18n before AI-assisted mapping/autobinding work; next mapping/autobinding work should still define backend/RLS/RPC contracts before implementation.
