    ...
    {activeTab === "campaigns" && !noData ? <>
      ...
      <SectionCard title="Кампанії" description="Ефективність кампаній" noPadding>
        ...
        <div className="overflow-x-auto">
          <Table><TableHeader><TableRow><TableHead className="py-2 text-sm">Кампанія</TableHead><TableHead className="whitespace-nowrap py-2 text-sm">Період</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">Витрати</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">Ліди</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">CPL</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">Кліки</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">CPC</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">Охоплення</TableHead></TableRow></TableHeader><TableBody>{visibleCampaignRows.map((r, i) => <TableRow key={`${r.campaign_name}-${i}`}><TableCell className="max-w-[360px] truncate py-2 text-sm" title={r.campaign_name}>{r.campaign_name}</TableCell><TableCell className="whitespace-nowrap py-2 text-sm">{formatPeriod(r.first_date, r.last_date)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{fmtCurrency(r.spend)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{fmtNum(r.leads)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{formatCostPer(r.cpl)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{fmtNum(r.clicks)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{formatCostPer(r.cpc)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{fmtNum(r.reach)}</TableCell></TableRow>)}</TableBody></Table>
        </div>
      ...
      {shouldShowPlacementsData ? <>
        ...
        <div className="overflow-x-auto">
          <Table><TableHeader><TableRow><TableHead className="py-2 text-sm">Плейсмент</TableHead><TableHead className="whitespace-nowrap py-2 text-sm">URL</TableHead><TableHead className="whitespace-nowrap py-2 text-sm">Період</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">Витрати</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">Реги</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">CPL</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">Кліки</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">CPC</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">Охоплення</TableHead><TableHead className="whitespace-nowrap py-2 text-right text-sm">Конв. ленда</TableHead></TableRow></TableHeader><TableBody>{visiblePlacementRows.map((r, i) => <TableRow key={`${r.placement_name}-${r.landing_url}-${i}`}><TableCell className="max-w-[360px] truncate py-2 text-sm" title={r.placement_name || "—"}>{r.placement_name || "—"}</TableCell><TableCell className="whitespace-nowrap py-2 text-sm">{r.landing_url ? <a href={r.landing_url} target="_blank" rel="noreferrer" className="underline">Відкрити</a> : "—"}</TableCell><TableCell className="whitespace-nowrap py-2 text-sm">{formatPeriod(r.first_date, r.last_date)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{fmtCurrency(r.spend)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{fmtNum(r.registrations)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{formatCostPer(r.cpl)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{fmtNum(r.clicks)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{formatCostPer(r.cpc)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{fmtNum(r.reach)}</TableCell><TableCell className="whitespace-nowrap py-2 text-right text-sm num">{r.landing_conversion == null ? "—" : `${(r.landing_conversion * 100).toFixed(1)}%`}</TableCell></TableRow>)}</TableBody></Table>
        </div>
        <div className="flex items-center justify-between px-4 pb-4 pt-2 text-sm">
