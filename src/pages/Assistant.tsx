...
export default function Assistant() {
  ...
  const showStarterPrompts = messages.length === 0 && !run.isPending;
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col px-1">
      <div className="flex flex-col justify-start pt-1 sm:pt-2 lg:pt-3">
        ...
        <div className="mx-auto mt-4 w-full max-w-3xl sm:mt-5">
          <div className="rounded-[1.75rem] border border-border/40 bg-card/95 p-2 shadow-lg shadow-foreground/5 ring-1 ring-foreground/5 transition focus-within:border-primary/30 focus-within:ring-primary/15">
