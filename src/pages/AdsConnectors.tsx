...
const copy = {
  uk: {
    ...
    adAccountsTestExplain: "Ці записи потрібні для перевірки сценаріїв. Вони не підтверджують активне підключення.",
    ...
    adAccountsNoRealExplain: "Активні привʼязані рекламні акаунти з’являться після OAuth-підключення та першої синхронізації акаунтів. Нижче можуть бути службові тестові прив’язки.",
    ...
    realAccount: "Активний привʼязаний акаунт",
    bindingScope: "Прив’язка",
    accountStatus: "Статус",
    testAccountNote: "Це тестова прив’язка. Вона не підтверджує активне підключення.",
    archivedAccountNote: "Цю прив’язку архівовано. Вона залишена для історії та перевірки.",
    realAccountHelper: "Активну привʼязку перевірено для синхронізації.",
    ...
    scheduledWarning: "Перед ручним запуском перевірте, що вибраний акаунт активний і прив’язаний до правильного проєкту/воронки.",
    scheduledInfo: "Активні привʼязані акаунти перевірено. Перед ручним запуском переконайтеся, що вибраний акаунт прив’язаний до правильного проєкту/воронки.",
    timezoneLabel: "Час",
    timezoneUtc: "UTC",
  ...
  en: {
    ...
    adAccountsTestExplain: "These records are used for scenario checks. They do not confirm an active connection.",
    ...
    adAccountsNoRealExplain: "Active bound ad accounts will appear after OAuth connection and the first account sync. Service test bindings may appear below.",
    ...
    realAccount: "Active bound account",
    bindingScope: "Binding",
    accountStatus: "Status",
    testAccountNote: "This is a test binding. It does not confirm an active connection.",
    archivedAccountNote: "This binding is archived. It remains visible for history and review.",
    realAccountHelper: "Active binding is verified for sync.",
    adAccountsEmpty: "Ad accounts are not bound yet.",
    scheduledTitle: "Sync",
    scheduledDescription: "Sync rules, current queue, and manual run controls.",
    scheduledWarning: "Before a manual run, confirm the selected account is active and bound to the correct project/funnel.",
    scheduledInfo: "Active bound accounts are verified. Before a manual run, confirm the selected account is bound to the correct project/funnel.",
    timezoneLabel: "Time",
    timezoneUtc: "UTC",
