...
const copy = {
  uk: {
    ...
    unboundRealAccountHelper: "Акаунт знайдений в Ads конекторах, але ще не прив’язаний до клієнта, проєкту або воронки. Відсутність spend/campaign даних ще не означає, що акаунт фейковий.",
    ...
    statusLabels: {
      ...
      completed: "Успішно",
      pending: "Очікує",
      "needs binding": "Потрібна прив’язка",
      needs_binding: "Потрібна прив’язка",
      no_data: "Без даних",
      blocked: "Заблоковано",
      queued: "У черзі",
      running: "Виконується",
  ...
  en: {
    ...
    unboundRealAccountHelper: "This account was found in Ads Connectors but is not bound to a client, project, or funnel yet. Missing spend/campaign data does not mean the account is fake.",
