...
const copy = {
  uk: {
    ...
    adAccountsNoRealExplain: "Реальні рекламні акаунти платформи з’являться після OAuth-підключення та першої синхронізації акаунтів. Вони можуть не мати spend/campaign даних; нижче можуть бути службові тестові прив’язки.",
  ...
  en: {
    ...
    adAccountsNoRealExplain: "Real platform ad accounts will appear after OAuth connection and the first account sync. They may have no spend/campaign data yet; service test bindings may appear below.",
