...
const copy = {
  uk: {
    ...
    facebookLeadFormsAttention: "Facebook Lead Ads: форми не знайдені. Sync і webhook перевірені, але ліди з’являться після наявності форм/подій.",
    ...
    noRealSyncDataYet: "Синхронізованих рекламних даних ще немає",
    noDataYet: "Даних ще немає",
    technicalStatus: "Технічний статус",
    operationalChecklist: "Операційна готовність",
    oauthStartCallback: "Безпечне підключення",
    realOAuthStillNeeded: "Активні OAuth-підключення",
    ...
    realConnectionNotCreated: "Активне підключення ще не створено",
    unknownConnectionState: "Стан невідомий",
    testBindingsNotReal: "Є тестові прив’язки, але підключення ще не завершено.",
    testBindingsNoRealOauth: "Є тестові прив’язки, але активного OAuth-підключення ще немає.",
    ...
    oauthMayCreate: "Після підключення система створить активний запис підключення.",
    ...
    adAccountsNoRealExplain: "Реальні рекламні акаунти платформи з’являться після OAuth-підключення та першої синхронізації акаунтів. Акаунт існує на рекламній платформі. Відсутність spend/campaign даних ще не означає, що акаунт фейковий.",
    ...
    unboundRealAccountHelper: "Акаунт знайдений в Ads конекторах, але ще не прив’язаний до клієнта, проєкту або воронки. Акаунт існує на рекламній платформі, але ще не привʼязаний до клієнта, проєкту або воронки. Відсутність spend/campaign даних ще не означає, що акаунт фейковий.",
    ...
    realAccountHelper: "Акаунт існує на рекламній платформі; відсутність spend/campaign даних ще не робить його фейковим.",
    ...
    scheduledWarning: "Перед ручним запуском перевірте, що вибраний акаунт є реальним акаунтом платформи і прив’язаний до правильного проєкту/воронки.",
    scheduledInfo: "Реальні акаунти платформи перевірено. Перед ручним запуском переконайтеся, що вибраний акаунт прив’язаний до правильного проєкту/воронки.",
    timezoneLabel: "Час",
    timezoneUtc: "UTC",
    ...
    fbOauthHelper: "Meta Ads підключено. Форми Lead Ads поки не знайдені. Вони з’являться після доступу до Facebook Page з формами Lead Ads або після створення форми.",
    healthStatus: "Стан",
    ...
    fbFormsEmpty: "Lead Ads форми поки не знайдені. Вони з’являться після доступу до Facebook Page з активними Lead Ads формами або після створення форми.",
    ...
    statusLabels: {
      ...
      no_active_connections: "Немає активних підключень",
  ...
  en: {
    ...
    facebookLeadFormsAttention: "Facebook Lead Ads: no forms found. Sync and webhook are verified; leads will appear after forms/events exist.",
    ...
    noRealSyncDataYet: "No synced ad data yet",
    noDataYet: "No data yet",
    technicalStatus: "Technical status",
    operationalChecklist: "Operational readiness",
    oauthStartCallback: "Secure connection",
    realOAuthStillNeeded: "Active OAuth connections",
    ...
    realConnectionNotCreated: "Active connection has not been created yet",
    unknownConnectionState: "Unknown",
    testBindingsNotReal: "Test bindings exist, but connection has not been completed yet.",
    testBindingsNoRealOauth: "Test bindings exist, but there is no active OAuth connection yet.",
    ...
    oauthMayCreate: "After connection, the system will create an active connection record.",
    ...
    adAccountsNoRealExplain: "Real platform ad accounts will appear after OAuth connection and the first account sync. The account can exist on the ad platform even before spend/campaign rows are available.",
    ...
    unboundRealAccountHelper: "This account was found in Ads Connectors, but it is not bound to a client, project, or funnel yet. This account exists on the ad platform but is not bound to a client, project, or funnel yet. Missing spend/campaign data does not mean the account is fake.",
    ...
    realAccountHelper: "This account exists on the ad platform; no spend/campaign data yet does not make it fake.",
    adAccountsEmpty: "Ad accounts are not bound yet.",
    scheduledTitle: "Sync",
    scheduledDescription: "Sync rules, current queue, and manual run controls.",
    scheduledWarning: "Before a manual run, confirm the selected account is a real platform account and bound to the correct project/funnel.",
    scheduledInfo: "Real platform accounts are verified. Before a manual run, confirm the selected account is bound to the correct project/funnel.",
    timezoneLabel: "Time",
    timezoneUtc: "UTC",
    ...
    fbOauthHelper: "Meta Ads is connected. Lead Ads forms have not been found yet. They will appear after access to Facebook Page Lead Ads forms or after a form exists.",
    healthStatus: "State",
    ...
    fbFormsEmpty: "Lead Ads forms have not been found yet. They will appear after access to a Facebook Page with active Lead Ads forms or after a form is created.",
