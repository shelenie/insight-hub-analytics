...
export default function Alerts() {
  ...
  return <DashboardLayout title="Telegram / Alerts" subtitle="Inspect Telegram routing, pending work queues, operational alerts, and HITL health.">
    <p className="mb-4 text-xs text-muted-foreground">{statusMessage}</p>{roleЗавантаження ? <p className="mb-4 text-xs text-muted-foreground">Завантаження workspace role permissions…</p> : null}{!roleЗавантаження && !canManage ? <p className="mb-4 text-xs text-muted-foreground">You do not have permission to manage Telegram alerts.</p> : null}{!roleЗавантаження && roleError ? <p className="mb-4 text-xs text-muted-foreground">Workspace role unavailable. Write actions are disabled for safety.</p> : null}
    {!session ? <SectionCard title="Telegram / Alerts" description="Authentication required"><p className="text-sm text-muted-foreground">Ви вийшли з системи. Увійдіть to access Telegram and operational alerts data.</p></SectionCard>
      : query.isЗавантаження ? <SectionCard title="Telegram / Alerts" description="Завантаження data"><p className="text-sm text-muted-foreground">Завантаження alerts workspace…</p></SectionCard>
