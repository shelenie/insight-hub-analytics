...
export const translations = {
  ...
  sourceDiagnosticsScope: { uk: "Діагностика на рівні робочого простору", en: "Workspace-level diagnostics" },
  sourceDiagnosticsRawFactPlacements: { uk: "Raw/fact плейсменти", en: "Raw/fact placements" },
  sourceDiagnosticsPerformancePlacements: { uk: "Performance плейсменти", en: "Performance placements" },
  sourceDiagnosticsMissingFromPerformance: { uk: "Відсутні у performance", en: "Missing from performance" },
  ...
  sourceDiagnosticsStatus: { uk: "Не рекламне / не performance джерело", en: "Non-ad / non-performance source" },
