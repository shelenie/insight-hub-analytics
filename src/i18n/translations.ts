...
export const translations = {
  ...
  conversionsDataStatus: { uk: "Дані: v_unified_funnel_* views · LIVE", en: "Data: v_unified_funnel_* views · LIVE" },
  ...
  conversionsRefunds: { uk: "Refunds", en: "Refunds" },
  conversionsNeedsReview: { uk: "На перевірці", en: "Needs review" },
  conversionsCollectedUsd: { uk: "Collected USD", en: "Collected USD" },
  conversionsCollectedUah: { uk: "Collected UAH", en: "Collected UAH" },
  conversionsDebt: { uk: "Debt", en: "Debt" },
  conversionsTariffTotal: { uk: "Tariff total", en: "Tariff total" },
