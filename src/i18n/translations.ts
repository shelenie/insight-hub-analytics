...
export const translations = {
  ...
  nonAdSourcesTitle: { uk: "Не рекламні / органічні джерела", en: "Non-ad / organic sources" },
  nonAdSourcesDescription: {
    uk: "Ці джерела є в raw/fact даних, але не входять у рекламні плейсменти з performance-метриками.",
    en: "These sources exist in raw/fact data, but are not included in paid placement performance metrics.",
  },
  nonAdSourcesDiagnosticsLabel: { uk: "Діагностика", en: "Diagnostics" },
  tableSource: { uk: "Джерело", en: "Source" },
  tableStatus: { uk: "Статус", en: "Status" },
  tableNote: { uk: "Пояснення", en: "Note" },
  nonAdSourceStatus: { uk: "Не рекламне джерело", en: "Non-ad source" },
  nonAdSourceNote: { uk: "Не входить у KPI «Плейсменти».", en: "Not included in the Placements KPI." },
