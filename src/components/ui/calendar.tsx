...
const UK_WEEKDAY_SHORT = ["Нд", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"] as const;

const formatUkWeekday = (date: Date) => UK_WEEKDAY_SHORT[date.getDay()];
...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      classNames={{
        months: "flex flex-col sm:flex-row gap-2 sm:gap-3",
        month: "space-y-2",
